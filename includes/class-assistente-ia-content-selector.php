        ...
        <div class="wrap assia-content-selector-wrap">
            ...
            <?php if ( ! $ever_configured ): ?>
                <div class="assia-warning">
                    ...
                    Questa è la prima volta che configuri la selezione contenuti. Per default, <strong>tutti i post e le pagine sono selezionati</strong>.<br>
                    Puoi deselezionare quelli che non vuoi indicizzare, quindi clicca "Salva Selezione".<br>
                    <?php if ( class_exists('WooCommerce') ): ?>
                    <strong>📦 I prodotti WooCommerce vengono sempre inclusi automaticamente</strong> e non necessitano di selezione manuale.
                    <?php endif; ?>
                </div>
            <?php else: ?>
                <div class="assia-cs-info">
                    ...
                    <?php if ( class_exists('WooCommerce') ): ?>
                    <strong>📦 I prodotti WooCommerce vengono sempre inclusi automaticamente</strong> (<?php 
                        $product_count = wp_count_posts('product');
                        echo $product_count->publish . ' prodotti pubblicati';
                    ?>).
                    <?php endif; ?>
                </div>
            <?php endif; ?>
