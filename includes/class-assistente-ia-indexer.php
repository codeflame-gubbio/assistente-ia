...
class Assistente_IA_Indexer {
    ...
    /**
     * Estrae testo pulito dal post: titolo + contenuto (strip shortcodes, strip tags)
     */
    protected static function build_clean_text($post) {
        $title = $post->post_title ? wp_strip_all_tags($post->post_title) : '';
        $content = $post->post_content;

        // Rimuove shortcodes (incluso Divi)
